<template>
    <div style="margin: auto">
        ...
        <div v-else-if="variable.type === vartypes.LIST">
            <list v-if="variable.lang.length > 0"
                :depth="depth"
                :variable="variable.lang"
        ...
        <div v-else-if="detailed && variable.type === vartypes.MATRIX" class="variable-unique md-elevation-4">
            ...
            <div class="variable-unique-content">
                ...
                <div class="md-elevation-4 variable-unique-value list" v-else>
                    <matrix :variable="variable.lang" :style="{ 'background-color': color(depth) }"></matrix>
                </div>
            </div>
        </div>
        <matrix v-else-if="variable.type === vartypes.MATRIX" :variable="variable.lang" :style="{ 'background-color': color(depth) }"></matrix>
        <funct v-else-if="variable.type === vartypes.FUNCTION" :variable="variable.lang"></funct>
        <div v-else-if="variable.type === vartypes.FLOAT" class="variable-unique md-elevation-4">
            <div class="variable-unique-text variable-unique-text-input">
                <span>Número de coma flotante [<b class="variable-unique-type">float</b>]</span>
            </div>
            <div class="variable-unique-content">
                <div class="md-elevation-4 variable-unique-value number">{{ variable.lang }}</div>
            </div>
        </div>
        <div v-else-if="variable.type === vartypes.NUMBER" class="variable-unique md-elevation-4">
            <div class="variable-unique-text variable-unique-text-input">
                <span>Número entero [<b class="variable-unique-type">int</b>]</span>
            </div>
            <div class="variable-unique-content">
                <div class="md-elevation-4 variable-unique-value number">{{ variable.lang }}</div>
            </div>
        ...
        <div v-else-if="detailed && variable.type === vartypes.CHAR" class="variable-unique md-elevation-4">
            ...
            <div class="variable-unique-content">
                ...
                <div class="md-elevation-4 variable-unique-value char" v-else>{{ variable.lang }}</div>
            </div>
        </div>
        <div v-else-if="detailed && variable.type === vartypes.BOOLEAN" class="variable-unique md-elevation-4">
            ...
            <div class="variable-unique-content">
                <div class="md-elevation-4 variable-unique-value boolean" :class="variable.class">{{ variable.lang }}</div>
            </div>
        </div>
        <div v-else>
            <span>{{ variable.lang }}</span>
        </div>
    </div>
</template>
<script>
